...
function HomePage() {
  ...
  const stats = {
    akunTerjual: t('accountsSoldCount'),
    kepuasan: t('satisfactionRate'),
    support: t('supportHours'),
  };
        ...
        <div>
          ...
          <div className="flex space-x-8 mt-8">
            <div>
              ...
              <p className="text-sm text-gray-500">{t('accountsSold')}</p>
            </div>
            <div>
          ...
          {loading ? (
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-purple-900/30 border border-gray-700 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-gray-400 text-sm">{t('level')} {akunUnggulan.level}</span>
              </div>
            ...
            <div className="bg-gray-900/50 border border-gray-700 rounded-2xl p-6 h-full flex items-center justify-center">
                <p className="text-gray-500">{t('noFeaturedAccount')}</p>
            </div>
          )}
        </div>
      </div>
